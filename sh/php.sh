...
wget $DOWNLOAD_URL/config_file/oniguruma-5.9.5-3.el7.x86_64.rpm -O oniguruma-5.9.5-3.el7.x86_64.rpm
wget $DOWNLOAD_URL/config_file/oniguruma-devel-5.9.5-3.el7.x86_64.rpm -O oniguruma-devel-5.9.5-3.el7.x86_64.rpm
yum -y install ./oniguruma-5.9.5-3.el7.x86_64.rpm ./oniguruma-devel-5.9.5-3.el7.x86_64.rpm;
